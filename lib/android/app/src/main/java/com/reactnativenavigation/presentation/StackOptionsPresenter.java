...
public class StackOptionsPresenter {
    ...
    public void mergeChildOptions(Options options, Component child) {
        Options withDefault = options.copy().withDefaultOptions(defaultOptions);
        mergeOrientation(withDefault.layout.orientation);
        mergeButtons(withDefault.topBar.buttons, withDefault.topBar.rightButtonColor, withDefault.topBar.leftButtonColor);
        mergeTopBarOptions(withDefault.topBar, withDefault.animations, child);
        mergeTopTabsOptions(withDefault.topTabs);
        mergeTopTabOptions(withDefault.topTabOptions);
    }
    ...
    @Nullable
    private List<Button> mergeButtonsWithColor(List<Button> buttons, com.reactnativenavigation.parse.params.Color buttonColor) {
